...
continent: Asia
country: Turkey
description: "A surreal volcanic landscape of fairy chimneys, underground cities, and rock-carved churches rising from the high Anatolian plateau, Cappadocia is one of earth's most otherworldly destinations. Sleep in a cave carved by Byzantine monks, then float over the valley in a hot air balloon at sunrise."
coverImage: /images/destinations/cappadocia.jpg
essentials:
  ...
  timezone: "UTC+3 (TRT)"
  visaInfo: "e-Visa required for most nationalities — apply at evisa.gov.tr. Cost ~$50 USD for most passports. US, UK, EU citizens eligible."
  plugType: "Type C/F (220V)"
bestTimeToVisit:
  summary: "April–June and September–November"
  details: "Spring wildflowers carpet the valleys and balloon conditions are ideal. Autumn brings golden light and harvest scenes. Winter (December–February) is magical with snow-dusted fairy chimneys, though some balloon flights are cancelled. Summer is hot and crowded."
mustSee:
...
Cappadocia rewards those who stay long enough to see it across different times of day. The light at golden hour turns the tuff formations into something molten. At night, cave hotel rooms hold a stillness that no standard hotel room can replicate.
