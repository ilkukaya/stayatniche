...
included:
  ...
  - Hot drinks (coca tea, coffee) during the session
  - Astrophotography guidance for those with cameras
  - Transport to the observation site from San Pedro
notIncluded:
  - Camera and tripod for astrophotography (bringing your own highly recommended)
  - Warm layers (temperatures drop significantly after sunset)
...
tags:
  ...
  - astrophotography
seo:
  metaTitle: "Stargazing in the Atacama Desert, Chile | StayAtNiche"
  metaDescription: "Experience the world's clearest night sky from 2,400m in the Atacama Desert. Professional telescopes, expert astronomers, and the Milky Way in full. From $55."
---

The Atacama Desert receives less than one millimetre of rain per year in some of its interior zones. It is the driest non-polar desert on Earth, and the combination of extreme aridity, minimal dust, high altitude, and almost no human settlement has created atmospheric conditions that are the reason the European Southern Observatory, the ALMA radio telescope array, and several other major international astronomical installations are located here. The sky above San Pedro de Atacama is, by any scientific measure, among the best on Earth for observing the universe.

What this means in practice, on a clear moonless night from a site outside the village, is difficult to convey without exaggeration. The Milky Way is not a suggestion or a faint band across the sky — it is a fully three-dimensional structure, with dark lanes of dust cutting through it and brighter regions that appear to have depth. The Large and Small Magellanic Clouds, satellite galaxies of the Milky Way at 160,000 and 200,000 light years distance respectively, are visible as distinct structures to the naked eye. Under the right conditions, the Milky Way produces enough light to cast a faint shadow of a person standing in the open desert.
