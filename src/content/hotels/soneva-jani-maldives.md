...
country: "Maldives"
description: "Visionary overwater retreat in remote Noonu Atoll, where retractable roof panels allow guests to sleep under the stars from their overwater villa and a series of waterslides connects the bedroom directly to the lagoon. Soneva Jani is the most inventive and playful overwater resort experience in the Maldives."
coverImage: /images/hotels/soneva-jani-maldives.jpg
gallery:
  - /images/hotels/soneva-jani-maldives-2.jpg
  - /images/hotels/soneva-jani-maldives-3.jpg
priceRange: "$2,500 - $20,000"
priceIndicator: 5
highlights:
  - "Retractable roof panels for open-air sleeping under the stars"
  - "Waterslide from the master bedroom directly into the lagoon"
  - "Remote Noonu Atoll, pristine marine environment"
  - "Observatory with the Maldives' largest telescopes"
amenities:
  - "Overwater villa with retractable roof"
  - "Private waterslide and lagoon access"
  - "Personal Mr./Ms. Friday butler"
  - "Soneva Spa"
  - "Cinema and observatory"
  - "Multiple restaurants, wine cave, and bar"
bestFor:
  - "Couples"
  - "Honeymooners"
...
Soneva Jani does not merely set the standard for overwater villa accommodation in the Maldives, it occupies a category of its own invention. Where other ultra-luxury Maldivian resorts compete on the scale of their infinity pools or the refinement of their spa menus, Soneva Jani has asked a more fundamental question: what would it mean to build an overwater villa that fully exploits the extraordinary nature of its setting? The answer, arrived at through architecture of genuine creative ambition: involves retractable roof panels, a waterslide from the master bedroom to the lagoon, and an outdoor movie screen above the water. It is, in the best sense, a resort that plays.

The property occupies an island in Noonu Atoll, a two-hour seaplane flight from Malé into waters that receive far fewer visitors than the more accessible north Malé atolls. The remoteness translates directly into marine quality: the reefs here are among the least impacted in the Maldives, and the density and diversity of marine life around the island is extraordinary. Snorkelling directly from the villa deck commonly produces encounters with reef sharks, turtles, eagle rays, and reef fish of every colour in the Indo-Pacific palette.
