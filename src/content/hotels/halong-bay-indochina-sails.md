...
highlights:
  ...
  - Tai chi at sunrise on the sundeck
  - Cooking class with local seafood
  - Kayak to deserted beaches
  - Sunset cocktails from the top deck
amenities:
  - En-suite bathroom
  - Air conditioning
  - Daily housekeeping
  - All meals included
  - Kayaks and rowing boat
  - Swimming ladder
bestFor:
  - Couples
  - Adventurers
...
prosAndCons:
  pros:
    - Unique floating experience in a UNESCO World Heritage Site
    - Meals and activities included in price
    - Kayaking caves accessible only by junk boat
    - Spectacular sunrise and sunset views
  cons:
    - Limited shore time
    - Weather-dependent (typhoon season June-August)
    - Can feel small for extended stays
bookingUrl: https://www.booking.com/hotel/vn/indochina-sails-ha-long.html
rating: 9.0
reviewCount: 1243
seasonalInfo:
  bestTime: October to April
  peakSeason: December to February
  notes: Avoid June-August typhoon season. October and November offer the clearest skies and calmest waters.
nearbyAttractions:
  - name: Thien Canh Son Cave
    distance: "2km by kayak"
  - name: Cap La Island
...
Ha Long Bay holds a particular power over travellers. Two thousand limestone islands erupt from the Gulf of Tonkin like ancient teeth, shrouded in mist and silence, accessible only by water. Staying on a floating junk hotel is the only way to truly experience this UNESCO World Heritage Site — and Indochina Sails does it beautifully.
