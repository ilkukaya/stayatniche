...
gallery:
 ...
 - "/images/hotels/hapuku-lodge-new-zealand-2.jpg"
 - "/images/hotels/hapuku-lodge-new-zealand-3.jpg"
priceRange: "$550 - $850"
priceIndicator: 4
highlights:
 - "Tree houses perched 8 meters above native manuka grove"
 - "Panoramic views of Kaikōura Ranges and the Pacific"
 - "On-site deer farm and organic kitchen garden"
 - "Whale watching, dolphin swimming, and seal colonies nearby"
 - "Family-owned lodge with genuine New Zealand hospitality"
amenities:
 - "Private balcony with mountain and ocean views"
 - "King or twin beds with luxury linens"
 - "En-suite bathroom"
 - "Underfloor heating"
 - "Mini-bar"
 - "Restaurant using ingredients from on-site garden and farm"
 - "Lounge and library"
 - "Free WiFi"
 - "Laundry facilities"
bestFor:
 - "Couples on a romantic escape"
 - "Wildlife and marine adventure seekers"
...
prosAndCons:
 pros:
 - "Spectacular dual views of mountains and ocean from the same balcony"
 - "Among the best luxury treehouse experiences in the Southern Hemisphere"
 - "Outstanding food made from genuinely local ingredients"
 - "Kaikōura offers some of the world's best accessible marine wildlife"
 - "Warm, personal service from a family-run operation"
 cons:
 - "Kaikōura is a 2.5-hour drive from Christchurch"
 - "Tree house access requires climbing stairs, not wheelchair accessible"
 - "Limited in-room entertainment by design"
 - "Popular, requires advance booking"
bookingUrl: "https://www.booking.com/hotel/nz/hapuku-lodge-amp-tree-houses.html"
rating: 9.2
reviewCount: 412
checkInOut:
 checkIn: "15:00"
...
seasonalInfo:
 ...
 notes: "New Zealand's South Island summers (December-February) are warmest and best for outdoor activities. Whale watching operates year-round from Kaikōura. Winter months are quieter and atmospheric, with snow on the Kaikōura Ranges creating dramatic backdrops."
nearbyAttractions:
 - name: "Kaikōura Whale Watch"
 distance: "5 km"
 - name: "Ohau Point Seal Colony"
 distance: "22 km"
 - name: "Kaikōura Peninsula Walkway"
 distance: "4 km"
 - name: "Nin's Bin (famous crayfish roadside stall)"
 distance: "25 km"
coordinates:
 lat: -42.3667
 lng: 173.6833
