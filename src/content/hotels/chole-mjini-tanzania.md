...
gallery:
  ...
  - "/images/hotels/chole-mjini-tanzania-2.jpg"
  - "/images/hotels/chole-mjini-tanzania-3.jpg"
priceRange: "$380 - $650"
priceIndicator: 4
highlights:
  - "Treehouses built within 19th-century Arab trading post ruins"
  - "One of Africa's most remote and authentic eco-lodges"
  - "Inside the Mafia Island Marine Park — world-class diving and snorkeling"
  - "Community-owned and operated, supporting the island's 2,000 residents"
  - "No electricity — lit entirely by lanterns and candles"
amenities:
  - "Open-air treehouse rooms with mosquito netting"
  - "En-suite bathroom"
  - "Fresh seafood restaurant"
  - "Bar"
  - "Diving and snorkeling excursions"
  - "Dhow sailing trips"
  - "Historical guided walks of Chole ruins"
  - "Whale shark swimming (seasonal)"
bestFor:
  - "Serious divers and marine enthusiasts"
  - "Travelers seeking genuine off-grid experiences"
...
prosAndCons:
  pros:
    - "Among the most authentic and remote eco-lodges in Africa"
    - "Exceptional diving in an uncrowded, pristine marine park"
    - "Genuinely community-owned with direct local benefit"
    - "The atmosphere of the ruins at night is unforgettable"
    - "Whale shark encounters (October-March) are world-class"
  cons:
    - "No electricity — requires genuine embrace of off-grid living"
    - "Significant travel required to reach (fly Dar es Salaam → Mafia, boat to Chole)"
    - "Open-air rooms mean insects are part of the experience"
    - "Not suitable for light packers — mosquito repellent essential"
bookingUrl: "https://www.booking.com/searchresults.html?ss=Chole+Mjini+Lodge+Tanzania"
rating: 9.0
reviewCount: 178
checkInOut:
  checkIn: "14:00"
  checkOut: "10:00"
seasonalInfo:
  bestTime: "June to October (dry season) and October to March (whale sharks)"
  notes: "The dry season (June-October) offers the best diving visibility and calmer seas. Whale sharks aggregate around Mafia Island from October to March. The short rains (November) and long rains (April-May) can make access difficult."
nearbyAttractions:
  - name: "Mafia Island Marine Park"
    distance: "0.5 km (by boat)"
  - name: "Chole Island Ruins"
    distance: "on-site"
  - name: "Juani Island"
    distance: "2 km"
...
seo:
  ...
  metaDescription: "Sleep in treehouses built within 19th-century Arab trading post ruins on Chole Island, Tanzania. Community-owned eco-lodge with world-class diving in Mafia Island Marine Park."
---
